...
class Settings(BaseSettings):
    ...
    # ===== 同花顺问财新闻搜索配置 =====
    IWENCAI_API_KEY: str = Field(default="", description="同花顺问财API密钥")
    IWENCAI_BASE_URL: str = Field(default="https://openapi.iwencai.com", description="同花顺问财API地址")
    IWENCAI_ENABLED: bool = Field(default=True, description="启用同花顺问财新闻数据源")
